...
#SEGMENT_DURATION = 0.15  # Segment length in seconds
...
# Load class indices
#phoneme_classes = {0: 'a', 1: 'b', 2: 'c'}  # Replace with your class mapping
# TIMIT 61 phonemes in alphabetical order
# timit_phonemes = [
...
#     'p', 'pau', 'pcl', 'q', 'r', 's', 'sh', 't', 'tcl', 'th', 'uh', 'uw', 'ux',
#     'v', 'w', 'y', 'z', 'zh'
# ]
...
def generate_and_save_mel_spectrogram(segment, sr, output_dir, index):
    ...
    S = librosa.feature.melspectrogram(y=segment, sr=sr, n_mels=N_MELS, n_fft=512, hop_length=320, fmax=FMAX)
